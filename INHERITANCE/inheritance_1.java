    ...
    public static void main(String[] args) {
      // base b = new base(); //creating an object of base class and acessing the value of base class but using derived object we cannot acess base 
       ...
       // System.out.println(b.getnum());
        ...
        d.setnum(3);
        System.out.println("Acessing parent class value using derived class object"+d.getnum());
        d.setnum2(2);
        System.out.println("Acessing derived class value using derived class object"+ d.getnum());
