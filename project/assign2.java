...
class Rectangle{
    ...
    Rectangle(int length, int breadth,int height,int width){
        this.length=length;
...
class Cuboid extends Rectangle{
  ...
  super(length, breadth,height,1); //without super the subclass will not get the value will be null.coz it overides the superclass we need need parameterized constructor
